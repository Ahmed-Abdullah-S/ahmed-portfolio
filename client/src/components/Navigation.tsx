...
export function Navigation() {
  ...
  return (
    <>
      ...
      >
        <Link href="/" className="text-xl font-bold font-display tracking-tight hover:text-primary transition-colors cursor-pointer">
      ...
      >
        <div className="flex justify-around items-center p-2">
          {links.map((link) => {
            ...
            return (
              <Link key={link.href} href={link.href} className={cn(
                "flex flex-col items-center gap-1 p-2 rounded-xl transition-colors min-w-[64px] cursor-pointer",
