        ...
        >
          <div className="glass-card p-8 rounded-3xl">
            ...
            <p className="text-muted-foreground leading-relaxed text-lg">
              {project.description} 
              {/* Adding mock extended description since content is brief */}
              <br /><br />
        ...
        >
          <div className="glass-card p-6 rounded-3xl space-y-4">
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full justify-between border-white/10 hover:bg-white/10" size="lg">
